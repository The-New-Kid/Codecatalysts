      ...
      <div class="w-full max-w-3xl bg-white rounded-3xl shadow-2xl p-6 sm:p-10 border-t-8 border-red-700" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label class="block font-semibold mb-1 text-gray-700">Select Seva Date</label>
              <input
                type="date"
            ...
            <div>
              <label class="block font-semibold mb-1 text-gray-700">No. of People</label>
              <input
                type="number"
                min="1"
        ...
        <!-- Seva Slot Selection -->
        <div class="mt-8">
          <label class="block font-serif font-bold mb-2 text-red-800 text-xl">Select Seva</label>
          <select 
            v-model="selectedSeva" 
            class="w-full p-3 border-2 border-gray-300 rounded-xl focus:border-red-700 focus:ring-2 focus:ring-red-200 transition duration-300 shadow-sm bg-white"
          >

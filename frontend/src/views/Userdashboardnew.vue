    ...
    <div class="relative w-full h-[500px] lg:h-[600px] overflow-hidden shadow-2xl">
      ...
      <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-5xl">
            ...
            <RouterLink to="#" class="glass-btn group">
                <div class="icon-circle text-orange-600">
                    <i data-feather="map" class="w-6 h-6"></i>
                </div>
                <div class="text-left">
                    <span class="block text-sm font-bold text-gray-800 group-hover:text-orange-700">Public Parking</span>
                    <span class="text-xs text-gray-500">Check availability</span>
                </div>
            </RouterLink>
            ...
            <RouterLink to="#" class="glass-btn group">
                ...
                <div class="text-left">
                    <span class="block text-sm font-bold text-gray-800 group-hover:text-purple-700">Private Parking</span>
                    <span class="text-xs text-gray-500">Reserved Spots</span>
                </div>
            </RouterLink>
...
<div class="w-full bg-yellow-100 border-b-2 border-yellow-300 overflow-hidden shadow-inner">
      <marquee behavior="scroll" direction="left" scrollamount="10" class="py-3 flex items-center">
        <span class="text-red-800 font-bold text-lg tracking-wide mx-4">
          🔔 Tatkal booking for Aarti and Darshan opens daily at 6:00 AM. Please plan your booking accordingly. || Jai Shri Mahakal 🙏
        </span>
      </marquee>
    </div>
